...
# In most cases, the project structure of those studying this book will differ from that of the author of this book.
# Therefore, it is necessary to add a path parameter to make the function more flexible.
